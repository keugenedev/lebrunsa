        ...
        >
          ...
          <div className="my-3 p-3 bg-white rounded-lg border border-slate-200 shadow-2xs w-full flex flex-col items-center">
            <Barcode 
              ...
              displayValue={true} 
            />
            <div className="flex items-center gap-1.5 mt-2 text-[10px] text-emerald-600 font-medium bg-emerald-50 px-2 py-0.5 rounded-full border border-emerald-100">
              <ShieldCheck className="w-3 h-3" />
              <span>Standard Code 128 • Compatible lecteur & douchette USB</span>
            </div>
          </div>
